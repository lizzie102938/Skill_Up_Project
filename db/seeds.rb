...
UserSkill.create(user: juliette, skill: fitness, description: "Cross-fit and weightlifting are my strengths ;) ")
UserSkill.create(user: paul, skill: english, description: "Native speaker!")
UserSkill.create(user: paul, skill: coding, description: "Front-end is my biggest strength, but can also help with Java")
