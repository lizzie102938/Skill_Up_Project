...
charlotte = User.create!(image: 'https://images.unsplash.com/photo-1605406575497-015ab0d21b9b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80', email: 'user12@example.com', password: 'user1212', username: 'Charlotte', points: 30, description: 'I have just finished studying but really want to learn more about coding and UX/UI design. Happy to teach people my skills and German too!', language: 'German', location: 'London', age: 23)
