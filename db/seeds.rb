...
michael = User.create(image:'https://images.unsplash.com/photo-1531384441138-2736e62e0919?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxfDB8MXxyYW5kb218MHx8cG9ydHJhaXR8fHx8fHwxNjQ1NzA5MTM1&ixlib=rb-1.2.1&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1080' , email: 'user4@example.com', password: 'user44', username: 'Michael', points: 20, description: 'I am 36 and have lived in Buenos Aires for 10 years now. Always happy to meet new people', language: 'Mandarin', location: 'Berlin', address: '10435, Berlin')
