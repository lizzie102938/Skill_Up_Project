...
paul = User.create(image: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2048&q=80', email: 'user9@example.com', password: 'user99', username: 'Paul', points: 10, description: 'This year I want to learn a new skill every month! Hoping I can find some fun people on Skill-Up to help me!', language: 'English', location: 'Madrid', age: 50, address: '28015, Madrid')
